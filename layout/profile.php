...
?>
            ...
            <h4 class="profile-section-heading"><?=$lang['Questionnaire_Tab_Title']?></h4>
          <p class="profile-section">
            <?php
            if(!empty($profile->has_traveled)) {
//              echo $lang['Has_Traveled'] . ": " .  $profile->has_traveled;
                    foreach($profile_page as $description){
